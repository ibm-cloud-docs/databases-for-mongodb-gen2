...
- **Location:** The deployment's cloud region. On Gen 2, {{site.data.keyword.databases-for-mongodb}} is currently available only in the **Montreal (ca-mon)**, **Chennai - Airtel (in-che)**, **Mumbai (in-mum)**, and **Frankfurt (eu-de)** regions.
