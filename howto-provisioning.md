...
- **Gen 2:** {{site.data.keyword.cloud}}'s latest platform, based on a highly secure software-defined networking architecture. Gen 2 is optimized for cloud-native applications and currently available only in Montreal, Chennai, Mumbai, Frankfurt, Madrid, Sydney, Washington, and London.
